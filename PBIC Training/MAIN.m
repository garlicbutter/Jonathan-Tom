...
p.Kp = 250; % for PID,PBIC
p.Kd = 30; % for PID,PBIC
p.K = 50; % for DBIC,PBIC, K stiffness coeff
p.B = 10; % for DBIC,PBIC, B damping coeff
...
% via function.
%
% Below are some example trajectory.
%
%octagon trajectory
...
p.init = [th1_init(1)-pi/2    0.0    th2_init(1)  0.0]'; %Initial conditions:
