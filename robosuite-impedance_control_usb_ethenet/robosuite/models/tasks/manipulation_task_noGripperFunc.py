...
class ManipulationTaskNoGripperFunc(MujocoWorldBase):
    """
        ...
        for obj_name, obj_mjcf in mujoco_objects.items():
            ...
            if obj_name == 'hole':
                for i, joint in enumerate(obj_mjcf.joints):
                    obj.append(new_site(name="{}_site{}".format(obj_name, i), size=(0.00005,)))
    ...
    def merge_hand_objects(self, mujoco_hand_object, is_visual=False):
        ...
        for obj_name, obj_mjcf in mujoco_hand_object.items():
            ...
            for i, joint in enumerate(obj_mjcf.joints):
                obj.append(new_site(name="{}_site{}".format(obj_name, i), pos=(0, 0, 0)))
            self.hand_objects.append(obj)
            obj[0].set("pos", array_to_string(np.array([0.0, 0.0, 0.092])))
