...
class PlateWith2_5mmHoleObject(MujocoXMLObject):
    """
    Square plate with a hole in the center (used in PegInHole)
    """

    def __init__(self, name=None, joints=None):
        super().__init__(xml_path_completion("objects/plate-with-hole-2_5mm.xml"), name=name, joints=joints)


class PlateWith5mmDifferenttHoleObject(MujocoXMLObject):
    """
    Square plate with a round, square and triangular hole shape in the center (used in PegInHole)
    """

    def __init__(self, name: object = None, joints: object = None) -> object:
        super().__init__(xml_path_completion("objects/plate-with-hole-5mm.xml"), name=name, joints=joints)
...
class ElectricPanel(MujocoXMLObject):
    """
    Electric Panel with three holes (used in PegInHole)
    """

    def __init__(self, name=None, joints=None):
        super().__init__(xml_path_completion("objects/electric_panel.xml"), name=name, joints=joints)


class BoardWithDiffConnectorsHoles(MujocoXMLObject):
    """
    Square plate with a hole in the center (used in PegInHole)
    """

    def __init__(self, name: object = None, joints: object = None) -> object:
        super().__init__(xml_path_completion("objects/Board_loading.xml"), name=name, joints=joints)


class EthernetConnector(MujocoXMLObject):
    """
    Square plate with a hole in the center (used in PegInHole)
    """

    def __init__(self, name: object = None, joints: object = None) -> object:
        super().__init__(xml_path_completion("objects/ethernet_cable.xml"), name=name, joints=joints)


class USBConnector(MujocoXMLObject):
    """
    Square plate with a hole in the center (used in PegInHole)
    """

    def __init__(self, name: object = None, joints: object = None) -> object:
        super().__init__(xml_path_completion("objects/usb_cable1.xml"), name=name, joints=joints)


class ElectricConnector(MujocoXMLObject):
    """
    Square plate with a hole in the center (used in PegInHole)
    """

    def __init__(self, name: object = None, joints: object = None) -> object:
        super().__init__(xml_path_completion("objects/electric_cable.xml"), name=name, joints=joints)


class ElectricConnector3Pins(MujocoXMLObject):
    """
    Square plate with a hole in the center (used in PegInHole)
    """

    def __init__(self, name: object = None, joints: object = None) -> object:
        super().__init__(xml_path_completion("objects/electric_cable_3_pin.xml"), name=name, joints=joints)

class BoardWithAllConnectorsHoles(MujocoXMLObject):
    """
    Square plate with a hole in the center (used in PegInHole)
    """

    def __init__(self, name: object = None, joints: object = None) -> object:
        super().__init__(xml_path_completion("objects/all.xml"), name=name, joints=joints)

class PlateWith5mmHoleObject(MujocoXMLObject):
    """
    Square plate with a hole in the center (used in PegInHole)
    """

    def __init__(self, name: object = None, joints: object = None) -> object:
        super().__init__(xml_path_completion("objects/plateHoleBlenderMakeMm.xml"), name=name, joints=joints)
